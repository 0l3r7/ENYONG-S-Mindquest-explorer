...
import PeAndHealthBG from './PhysicalEducationAndHealthBackground/MAPEHBG.png'
...
function PhysicalEducationAndHealthQuiz() {

  // ----------------------------
  // State variables
  // ----------------------------
  const [subject, setSubject] = useState("PHYSICAL EDUCATION AND HEALTH");        // Current quiz subject
  ...
  const [question, setQuestion] = useState("PHYSICAL EDUCATION AND HEALTH SUBJECT QUESTION"); // Current question text
  ...
  return (
    ...
    style={{backgroundImage:`url(${PeAndHealthBG})`}}
    >
      ...
      ---------------------------- */}
        <div className='flex justify-center pb-4'>
          <div 
            className='  bg-[#081E41] border-2  border-white shadow-[inset_0_0_15px_rgba(0,0,0,0.6)] 
                            cursor-pointer  px-6 h-10 flex justify-center items-center rounded-full '>
              <h1 
              className=' font-IN  text-white wrap-break-word font-bold'>
              {subject}
              </h1>
          </div>
        </div>
...
export default PhysicalEducationAndHealthQuiz