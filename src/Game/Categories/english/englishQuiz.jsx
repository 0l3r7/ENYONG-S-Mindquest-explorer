...
import EnglishBg from './EnglishBackground/EnglishBg.png'
...
// ----------------------------
  // State variables
  // ----------------------------
  const [subject, setSubject] = useState("ENGLISH");        // Current quiz subject
  ...
  const [question, setQuestion] = useState("ENGLISH SUBJECT QUESTION"); // Current question text
  ...
  return (
    ...
    <div
      ...
      style={{backgroundImage:`url(${EnglishBg})`}}
      >
