...
import MathBG from './MathBackground/MathBG.png'
...
function MathQuiz() {
  ...
  // State variables
  // ----------------------------
  const [subject, setSubject] = useState("MATHEMATICS");        // Current quiz subject
  ...
  const [question, setQuestion] = useState("MATHEMATICS SUBJECT QUESTION"); // Current question text
  ...
  return (
    ...
    style={{backgroundImage:`url(${MathBG})`}}
    >
