...
import GMRCBG from './GMRCBackground/GMRCBG.png'
...
function GMRCQuiz() {
  ...
  // State variables
  // ----------------------------
  const [subject, setSubject] = useState("GMRC");        // Current quiz subject
  ...
  const [question, setQuestion] = useState("GMRC SUBJECT QUESTION"); // Current question text
  ...
  return (
    ...
    style={{backgroundImage:`url(${GMRCBG})`}}
    >
