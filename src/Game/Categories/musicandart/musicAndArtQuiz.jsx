...
import MusicAndArtBG from './MusicAndArtBackground/MAPEHBG.png'
...
function MusicAndArtQuiz() {

  // ----------------------------
  // State variables
  // ----------------------------
  const [subject, setSubject] = useState("MUSIC AND ARTS");        // Current quiz subject
  ...
  const [question, setQuestion] = useState("MUSIC AND ARTS SUBJECT QUESTION"); // Current question text
  ...
  return (
    ...
    style={{backgroundImage:`url(${MusicAndArtBG})`}}
    >
...
export default MusicAndArtQuiz